...
impl<T> Pond<T> {
  ...
  /// Intented primarily for gpu streaming, but I'm sure there are other uses.
  /// This should only be used when you have some sort of access scheme independent of the internal tracker
